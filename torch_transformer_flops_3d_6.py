...
if __name__ == '__main__':
    ...
    for tensor_mp_size in [1]:
        for num_attention_heads in [256]:#[96],128,256,512]:# [32,128]: #[32, 64, 96, 128]:
            for hidden_size in range(21504,(2**15),num_attention_heads): #[32768]: #range(8192,2**15, num_attention_heads):
    ...
    for tensor_mp_size in [1]:
        for num_attention_heads in [512]:#[96],128,256,512]:# [32,128]: #[32, 64, 96, 128]:
            for hidden_size in range(num_attention_heads,(2**15),num_attention_heads): #[32768]: #range(8192,2**15, num_attention_heads):
                for microbatch_size in [4]:
                    for vocab_size in [51200]:
                        configurations.append((microbatch_size, hidden_size,
                                           (tensor_mp_size, 1, 1), num_attention_heads,vocab_size))
