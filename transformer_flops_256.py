...
if __name__ == '__main__':
    ...
    configurations = []
    for hidden_size in range(22784,32768+128,128): #range(19584,80*128 + 12288, 128): # range(12288-128*20,12288 + 80*128,128): #[12288]:
        for tensor_mp_size in [1]:
            for num_attention_heads in [128]: #[32, 64, 96, 128]:
