...
#do
#	echo $i
#	MASTER_PORT=$((6000 + $i)) ROCR_VISIBLE_DEVICES=$i python torch_transformer_flops${i}.py | tee -a results/max_h_sweep_mi250_${i}.out &
#done
#wait
i=0
ROCR_VISIBLE_DEVICES=$i python mm_flops.py | tee -a results/mi250_mm_data.out &
i=2
ROCR_VISIBLE_DEVICES=$i python bmm_flops.py | tee -a results/mi250_bmm_data.out &
wait 