...
if __name__ == '__main__':
    ...
    for tensor_mp_size in [1]:
        for num_attention_heads in [128]:# [32,128]: #[32, 64, 96, 128]:
            # need 20352 to 32k and 9216 to 16k
            for hidden_size in range(21632,(2**15) + num_attention_heads,num_attention_heads): #[32768]: #range(8192,2**15, num_attention_heads):
