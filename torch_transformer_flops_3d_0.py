...
if __name__ == '__main__':
    ...
    for tensor_mp_size in [1]:
        for num_attention_heads in [16]:#[8,12,16]:# [32,128]: #[32, 64, 96, 128]:
            for hidden_size in range(24416,(2**15),num_attention_heads): #[32768]: #range(8192,2**15, num_attention_heads):
