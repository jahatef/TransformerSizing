...
if __name__ == '__main__':
    ...
    for tensor_mp_size in [1]:
        for num_attention_heads in [128]: #[8, 12, 16, 20, 24, 32, 40, 64, 80, 96, 128, 256, 512]: # [32,128]: #[32, 64, 96, 128]:
            for hidden_size in range(2**15//8,2**15//4,num_attention_heads): # range(num_attention_heads*8,2**15 + num_attention_heads,num_attention_heads*8): #[32768]: #range(8192,2**15, num_attention_heads):
